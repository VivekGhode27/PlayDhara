...
export const LEVELS: Level[] = [
  {
    ...
    arrows: [
      ...
      { id:'a4', color:'#F39C12', direction:'up',    row:2, col:0, size:2 },
    ]
  },
  {
    id: 2,
  ...
  },
  {
    ...
    arrows: [
      ...
      { id:'a5', color:'#9B59B6', direction:'right', row:2, col:0, size:2 },
      { id:'a6', color:'#1ABC9C', direction:'down',  row:3, col:2, size:2 },
      { id:'a7', color:'#E67E22', direction:'up',    row:4, col:0, size:2 },
      { id:'a8', color:'#E91E63', direction:'left',  row:4, col:3, size:3 },
    ]
  },
];
